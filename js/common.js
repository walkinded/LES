...
if($(window).width() < 1301) {
  $(".infrastructure-map__pin").find('.map-pin__desc').addClass('map-pin__desc-active');
} else {
  $(".infrastructure-map__pin img").click(function() {
		$('.map-pin__desc').removeClass('map-pin__desc-active');
		$(this).siblings(".map-pin__desc").toggleClass('map-pin__desc-active');
	});
}
